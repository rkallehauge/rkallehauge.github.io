...
export const siteConfig: SiteConfig = {
	title: "Rasmus Portfølje",
	subtitle: "My portfolio and stuff",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "Min GitHub",
			url: "https://github.com/rkallehauge", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// },
		{
			...
			url: "https://github.com/rkallehauge",
		},
	],
};
